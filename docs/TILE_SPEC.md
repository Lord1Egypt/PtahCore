...
1. **Fixed outline.** Width/height are a multiple of the ASAP7 site grid
   and identical across all instances. The array places them on a regular
   pitch with zero inter-tile gap.
